...
<html>
    <head>
        ...
        <style>
            ...
            .banner-sec{background:url(https://www.takadada.com/wp-content/uploads/2019/07/hinh-nen-sieu-xe-Bugatti-1.jpg)  no-repeat left bottom; background-size:cover; min-height:500px; border-radius: 0 10px 10px 0; padding:0;}
            ...
            .banner-text h2{color: red; font-weight:600;}
            .banner-text h2:after{content:" "; width:100px; height:5px; background:#FFF; display:block; margin-top:20px; border-radius:3px;}
            .banner-text p{color: #ffff;}
